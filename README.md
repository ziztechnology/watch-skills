# Toooony Open-Source Skills

> [!NOTE]
> If you use the [open-source watch face template](https://github.com/ziztechnology/watch-oss-template) directly, you do not need to install this Skills package manually because it is already included.

## Installation

```bash
npx skills add ziztechnology/watch-skills
```
